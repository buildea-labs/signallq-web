...
const SECTIONS: DocSection[] = [
  ...
  { title: 'Latência sob carga', text: 'A maioria dos testes só mede latência em repouso. O SignallQ também mede sob download e upload simultâneos, o que ajuda a identificar bufferbloat, uma causa comum de travamento com sinal forte.' },
  ...
  { title: 'Diagnóstico, não só número', text: 'Em vez de parar no resultado, o SignallQ aponta causas prováveis (Wi-Fi, DNS, instabilidade da rede) e o que fazer a seguir.' },
